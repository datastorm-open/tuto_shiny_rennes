...
Pour clore cette formation **Shiny**, nous vous proposons la réalisation d’un mini-projet. Celui-ci consistera en la création d’une application Shiny qui répondra à l’une de vos problématiques métier, à partir d’un jeu de
