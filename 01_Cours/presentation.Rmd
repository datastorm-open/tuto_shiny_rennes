---
title: "Premiers pas avec R Shiny...  <br> et les packages de visualisation interactive"
author: "Benoît Thieurmel <br> Thibaut Dubois - thibaut.dubois@datastorm.fr <br> Julien Bretteville - julien.bretteville@datastorm.fr" 
output:
...
```{r child = 'slides/07_observe_update.Rmd'}
```

```{r child = 'slides/08_isolation.Rmd'}
```

```{r child = 'slides/09_reactive.Rmd'}
```

```{r child = 'slides/10_conditionnal.Rmd'}
```
